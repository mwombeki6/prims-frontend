...
export function SideNav() {
  ...
  async function studentDashboard() {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/api/student/student_dashboard`,
      {
        method: "GET",
        headers: {
    ...
    return { username: data.user.email };
  }
          ...
          <Navbar.Section grow component={ScrollArea} mx="-lg" px="sm">
            ...
            <Navbar.Section className={classes.section}>
              <div className="-space-y-1">
                ...
                <div className={classes.mainLinks}>
                  <NextLink href={"/dashboard/publication"}>
                    <UnstyledButton className={classes.mainLink}>
                      <div className={classes.mainLinkInner}>
                        <IconCheckbox
                          //color="blue"
                ...
                <div className={classes.mainLinks}>
                  <NextLink href={"/dashboard/research"}>
                    <UnstyledButton className={classes.mainLink}>
                      <div className={classes.mainLinkInner}>
                        <IconListSearch
                          //color="blue"
