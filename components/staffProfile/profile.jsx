...
export const StaffProfile = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/staff/get_user`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          ...
          <Paper radius="lg" shadow="xl" p="lg" withBorder>
            ...
            <Paper radius="lg" shadow="xl" p="lg" withBorder>
              ...
              <div className="flex">
                ...
                <Space w={10} />
                <div className="font-light">{data.education_background}</div>
              </div>
              <Space h={10} />
              <div className="flex">
                <div className="font-extrabold text-white font-mono">
              ...
              <div className="flex">
                ...
                <Space w={10} />
                <div className="font-light">{data.employee_number}</div>
              </div>
            </Paper>
            <Space h={40} />
          </Paper>
